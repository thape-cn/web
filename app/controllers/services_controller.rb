class ServicesController < ApplicationController
  def building
    render 'services', locals: {
      ...
      ps: ['天华建筑秉持“创意与技术完美融合”的品牌理念，致力于汇聚并培养专业人才团队，追求“体验与整合”为导向的创新设计。通过全国主要城市的分支机构网络，服务全国的客户和项目，专注营造高品质城市空间、生活空间、工作空间、文化空间等优秀的建筑产品，提供建筑、结构及机电等全专业工程咨询与设计全过程服务，涉足领域包括：城市设计、城市更新、城市综合体、住宅、商业、办公、TOD、文化、医养、教育、旅居酒店等。',
           '天华建筑长期立足于中国城市的快速发展方向，积极与国内外顶尖学术机构合作，设立八大研究中心，推动前沿课题的研究与实践，与客户、行业上下游合作伙伴携手同行，为解决中国城市建设与发展问题不懈努力，践行“引领生活方式，助力城市发展”的使命。'],
  ...
  def landscape
    render 'services', locals: {
      ...
      ps: ['天华景观凭借优秀的设计水准及专业完善的服务体验赢得业界好评，以地产开发商为主要客户，围绕其主导的住宅、商业、文旅、办公、代建绿地等各领域项目进行了长期实践，与众多知名客户形成了长期合作关系。',
           '2013年上海天华园林景观有限公司正式成立，成为天华集团在景观业务的全资子公司。全新打造的天华景观专业团队，具有国际化的人才队伍组合、完善的技术力量、全程化的总体服务、严谨的工作流程。目前，天华景观在上海、重庆均设有办公室。',
           '天华景观将设计聚焦于项目的本质，最大化挖掘场地潜力，基于科学严谨的设计分析、创新的解决方案以及高效合理的工作流程，为客户提供最合理、最经济、符合可持续发展要求的设计方案。'],
