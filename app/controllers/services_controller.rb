class ServicesController < ApplicationController
  ...
  def building
    render 'services', locals: {
      background_img: 'media/images/building.jpg', service_mt: 'mt-6',
      chinese_title: '建筑设计',
  ...
  def interior
    render 'services', locals: {
      background_img: 'media/images/interior.jpg', service_mt: 'mt-3',
      chinese_title: '室内设计',
  ...
  def planning
    render 'services', locals: {
      background_img: 'media/images/planning.jpg', service_mt: 'mt-4',
      chinese_title: '城市规划',
  ...
  def landscape
    render 'services', locals: {
      background_img: 'media/images/landscape.jpg', service_mt: 'mt-12',
      chinese_title: '景观设计',
  ...
  def vetting
    render 'services', locals: {
      background_img: 'media/images/vetting.jpg', service_mt: 'mt-12',
      chinese_title: '审图',
      english_title: 'DRAWING REVIEW',
      ps: ['虹核审图业务团队主营建设工程审图，2001年获得上海市建交委员会颁发的上海市建设工程施工图设计文件审查（一类含超限高层）机构认定资质，是上海市最早的11家审图机构之一。并于2006年12月获得ISO9001质量体系认证证书，建有一套质量保证体系和管理标准。审查总量在全市审查机构中名列前茅，并多年被主管部门评为先进单位。']
    }
  end

  def consluting
    render 'services', locals: {
      background_img: 'media/images/consluting.jpg', service_mt: 'mt-10',
      chinese_title: '技术咨询',
      english_title: 'CONSULTATION',
      ps: ['基于天华在民用建筑设计领域数十年的耕耘，天华技术咨询厚积薄发，源于设计，高于设计，可提供项目全生命周期的技术顾问咨询服务，服务范围涵盖选型优化、效果实现、成本预控、超高超限分析、新技术研发和应用（PC、BIM、钢结构...）、 标准编制、第三方审核、抗震审批、更新改建等。',
           '通过我们先进的技术、高效的组织和优质的服务，能够最大限度地实现客户的价值目标，为节能环保型社会做出贡献。']
    }
  end

  def vrtech
    render 'services', locals: {
      background_img: 'media/images/vrtech.jpg', service_mt: 'mt-7',
      chinese_title: '可视化',
      english_title: 'VR TECHNOLOGY',
      ps: ['VR（虚拟现实）是当下最热门的前沿技术之一，VR在建筑领域的应用将给地产行业带来全新的思维模式和工作流程。易术家是建筑VR内容领域的先行者，定位于包括 VR / AR 在内的各种新技术在房地产市场和设计表现领域的垂直细分市场，致力于结合新兴的科技手段和集团在业内领先的建筑美学表达经验，提供高品质的VR产品和服务，着力解决行业需求和改革现有的表达方式。',
