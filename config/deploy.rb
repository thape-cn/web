...
append :linked_files, *%w[puma.rb config/database.yml config/master.key config/secrets.yml db/thape_prod.sqlite3 db/tianhua2019.sqlite3 db/tianhua2020.sqlite3 config/credentials.yml.enc]
